    ...
    >
      <div className="mx-[5%] max-w-[40rem] justify-self-start lg:ml-[5vw] lg:mr-20 lg:justify-self-end">
        <h1 className="mb-5 text-6xl font-bold md:mb-6 md:text-9xl lg:text-10xl">
          Empowering Alcohol Brands to Sell Directly
        </h1>
        <p className="md:text-md">
          At Tipple, we streamline the process for alcohol brands to connect
          directly with consumers and businesses worldwide. Our comprehensive
          infrastructure ensures compliance with all tax, legal, and logistical
          requirements, allowing you to focus on what you do best: crafting
