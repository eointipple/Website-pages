      ...
      <div className="container">
        ...
        <div className="grid grid-cols-1 items-start justify-center gap-x-8 gap-y-12 md:grid-cols-3 md:gap-x-8 md:gap-y-16 lg:gap-x-12">
          <div className="flex flex-col text-center">
            ...
            <p>
              Alice brings over a decade of experience in the alcohol industry
          ...
          <div className="flex flex-col text-center">
            ...
            <p>
              Mark is an expert in technology solutions, ensuring seamless
          ...
          <div className="flex flex-col text-center">
            ...
            <p>
              Sarah crafts compelling narratives that resonate with our audience
          ...
          <div className="flex flex-col text-center">
            ...
            <p>
              Tom drives our sales strategy, connecting with partners and
          ...
          <div className="flex flex-col text-center">
            ...
            <p>
              Emily ensures our logistics run smoothly, managing compliance and
          ...
          <div className="flex flex-col text-center">
            ...
            <div className="mb-3 md:mb-4">
              <h5 className="text-md font-semibold md:text-lg">James Wilson</h5>
              <h6 className="md:text-md">Finance Officer</h6>
            </div>
            <p>
              James oversees financial strategies, ensuring sustainable growth
